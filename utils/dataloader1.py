...
class KvasirDataset(data.Dataset):
    ...
    """
    def __init__(self, image_root, gt_root, img_size, jitter=0.5):
...
def get_loader(image_root, gt_root, batchsize, img_size=384, shuffle=True, num_workers=4, pin_memory=True, jitter=0.5):

    dataset = KvasirDataset(image_root, gt_root, img_size=img_size, jitter=jitter)
